...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        if 'Ricky06662' in data_path:
            self.dataset = load_dataset(data_path)['train']
        else:
            self.dataset = load_from_disk(data_path) # you can load from disk if you have already downloaded the dataset
        ...
        if len(self.dataset) > subset_size:
            ...
            print(f'[INFO] ==> The dataset size is {len(self.dataset)}, seed is {seed}')
    ...
    def __getitem__(self, index):
        ...
        messages = [
            ...
            {"role": "user", "content": self.user_prompt.format(
                ...
                # Answer='{"bbox": [10,100,200,210], "points_1": [30,110], "points_2": [35,180], "neg_points_1": [11,105], "neg_points_2": [40,200]}',
                Caption="a red apple")},
